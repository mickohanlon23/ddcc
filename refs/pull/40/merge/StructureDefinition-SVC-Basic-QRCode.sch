...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      <sch:assert test="count(f:extension[@url = 'https://who-int.github.io/svc/refs/heads/rc2/StructureDefinition/SVC-QRCode']) &gt;= 1">extension with URL = 'https://who-int.github.io/svc/refs/heads/rc2/StructureDefinition/SVC-QRCode': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://who-int.github.io/svc/refs/heads/rc2/StructureDefinition/SVC-QRCode']) &lt;= 1">extension with URL = 'https://who-int.github.io/svc/refs/heads/rc2/StructureDefinition/SVC-QRCode': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
